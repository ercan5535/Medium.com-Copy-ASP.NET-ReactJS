...
namespace UserService.Helpers
{
    ...
    {
        public static string CreateJwtToken(UserGetDto userGetDto, string tokenType, string secretKey, DateTime expiration)
        {
        ...
        public static (int UserId, DateTime Expiration, string TokenType) DecodeJwtToken(string jwtToken, string secretKey)
        {
            var tokenHandler = new JwtSecurityTokenHandler();
            ...
            return (userId, expiration, tokenType);
        }
    }
}